 ...
 *
 * Original from: https://raw.githubusercontent.com/matheuss/google-translate-token/refs/heads/master/index.js
 * Modified by OFIReyeees - y. 2025
 */
...
function updateTKK() {
    return new Promise(function (resolve, reject) {
        ...
        if (Number(window.TKK.split('.')[0]) === now) {
            ...
            axios.get('https://translate.google.com').then(function (res) {
